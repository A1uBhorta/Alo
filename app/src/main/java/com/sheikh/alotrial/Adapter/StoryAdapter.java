...
import com.sheikh.alotrial.AddStoryActivity;
import com.sheikh.alotrial.Model.Story;
import com.sheikh.alotrial.Model.User;
import com.sheikh.alotrial.R;
import com.sheikh.alotrial.StoryActivity;
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                if (click) {
                    if (count > 0) {
                        ...
                        alertDialog.setButton(AlertDialog.BUTTON_NEGATIVE, "View Story",   ///HERE
